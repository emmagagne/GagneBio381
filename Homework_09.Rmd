...
## Redoing Homework 8 in a Controlled Structure
Using controlled structured programming, I will be organizing my previous homework into discrete functions.
...
![box plot](https://github.com/emmagagne/GagneBio381/blob/main/hw09.png?raw=true )

## Part 2: Using a different type of data set to generate a linear regression
...
The resulting regression line obtained:
![linreg](https://github.com/emmagagne/GagneBio381/blob/main/linreg.png?raw=true)
