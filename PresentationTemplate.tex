...
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
 %\begin{figure}
   %\includegraphics[width=1.0\linewidth]{images/UVMLogo.jpg}
...
\end{alltt}
\begin{verbatim}
##  [1] 0.019680419 0.988532688 0.349314493 0.151544424 0.683799760 0.001184617
##  [7] 0.763265115 0.398763147 0.740630776 0.395818427
\end{verbatim}
\end{kframe}
\end{knitrout}
